...
/**
 * В массиве целых чисел найти индексы двух элементов, которые в сумме дают заданное число. Найти превое решение
 * Вернуть массив с индексами найденных элементов
 * Пример: [2, 7, 11, 15], target 9. result: [0, 1]
 * <p>
